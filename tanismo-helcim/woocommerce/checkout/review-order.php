 ...
 * Date: 04/19/2024
 * Note: Update this class if a new version of woocommerce updates this template and this version is no longer compatible
 */
?>
	    ...
	    <tr class="order-fee">
            ...
            <td>
                <span class="woocommerce-Price-amount amount">
                    <?php
                        $fee = (float) preg_replace("/[^0-9.]/", "", WC()->cart->get_cart_contents_total()) * 0.03;
